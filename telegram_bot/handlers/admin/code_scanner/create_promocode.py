...
from filters import LocalizedTextFilter, AdminPromocodeCreatingFilter, PrivilegeCallbackFilter, PrivilegeMessageFilter
...
code_scanner_router.message.filter(PrivilegeMessageFilter(AdminPrivilege.EDIT_PROMOCODES.value))
code_scanner_router.callback_query.filter(PrivilegeCallbackFilter(AdminPrivilege.EDIT_PROMOCODES.value))
