...
code_scanner_router.message.filter(PrivilegeFilter(AdminPrivilege.EDIT_PROMOCODES))
code_scanner_router.callback_query.filter(PrivilegeFilter(AdminPrivilege.EDIT_PROMOCODES))
