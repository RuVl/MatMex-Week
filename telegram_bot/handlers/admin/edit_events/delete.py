...
@edit_events_delete_router.message(EditShopActions.EDIT_SHOP, LocalizedTextFilter("btn-delete-item-or-category"))
...
@edit_events_delete_router.callback_query(ShopDeleteItemFactory.filter(F))
...
@edit_events_delete_router.callback_query(ShopDeleteCategoryFactory.filter(F))
