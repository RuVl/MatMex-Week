...
shop_hello = Добро пожаловать в магазин! На картинке вы можете увидеть цены и возможные категории. Выберите категорию по ссылке ниже.
shirts-type = Вот какие есть виды футболок: