...
class Privilege(Base):
	...
	privilege: Mapped[AdminPrivilege] = mapped_column(AdminPrivilege, nullable=False, comment="привилегии администрирования")
	...
	provider_id: Mapped[int] = mapped_column(ForeignKey("users.id"), nullable=False, comment="кем выданы")
